...
import (
	"github.com/softiron/hypercloud-api/cloud/vnet"
)
...
type VNet struct {
	...
	Template             vnet.Template       `json:"template" yaml:"template"`
	AddressRanges        []vnet.AddressRange `json:"arpool" yaml:"arpool"`
}
