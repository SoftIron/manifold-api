...
// CreateComputeHostRequest is the request body for POST /compute/host.
...
// SetComputeHostStatusRequest is the request body for PATCH /compute/host/{host}/status.
type SetComputeHostStatusRequest struct {
	Status string `json:"status"`
}

// UpdateComputeHostRequest is the request body for PATCH /compute/host/{host}.
type UpdateComputeHostRequest struct {
	Template string `json:"template"`
	Merge    bool   `json:"merge"`
}

// RenameComputeHostRequest is the request body for PATCH /compute/host/{host}/name.
type RenameComputeHostRequest struct {
	Hostname string `json:"hostname"`
}
...
// CreateVNCProxyRequest is the request body for POST /instance/{instance}/vnc.
